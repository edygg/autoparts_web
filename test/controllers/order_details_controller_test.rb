...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { discount: @order_detail.discount, order_id: @order_detail.order_id, quantity: @order_detail.quantity, replacement_id: @order_detail.replacement_id, unit_price: @order_detail.unit_price }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { discount: @order_detail.discount, order_id: @order_detail.order_id, quantity: @order_detail.quantity, replacement_id: @order_detail.replacement_id, unit_price: @order_detail.unit_price }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
